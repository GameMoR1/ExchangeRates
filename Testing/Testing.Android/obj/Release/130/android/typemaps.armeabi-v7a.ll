...
@module8_managed_to_java = internal constant [504 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
...
@module8_managed_to_java_duplicates = internal constant [235 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
...
@module14_managed_to_java = internal constant [82 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
...
@module14_managed_to_java_duplicates = internal constant [37 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
...
@map_modules = global [25 x %struct.TypeMapModule] [
	...
	%struct.TypeMapModule {
		[16 x i8] c"\07k\01KA0\CAE\B1\D6\13\AF7\10\C1\0A", ; module_uuid: 4b016b07-3041-45ca-b1d6-13af3710c10a
		i32 2, ; entry_count
	...
	; 2
	%struct.TypeMapModule {
		[16 x i8] c"\1E\A6#G\A6\14a@\86\E7!\88\B6t%`", ; module_uuid: 4723a61e-14a6-4061-86e7-2188b6742560
		i32 1, ; entry_count
		i32 0, ; duplicate_count
	...
	%struct.TypeMapModule {
		...
		%struct.TypeMapModuleEntry* getelementptr inbounds ([504 x %struct.TypeMapModuleEntry], [504 x %struct.TypeMapModuleEntry]* @module8_managed_to_java, i32 0, i32 0), ; map
		%struct.TypeMapModuleEntry* getelementptr inbounds ([235 x %struct.TypeMapModuleEntry], [235 x %struct.TypeMapModuleEntry]* @module8_managed_to_java_duplicates, i32 0, i32 0), ; duplicate_map
	...
	%struct.TypeMapModule {
		...
		%struct.TypeMapModuleEntry* getelementptr inbounds ([82 x %struct.TypeMapModuleEntry], [82 x %struct.TypeMapModuleEntry]* @module14_managed_to_java, i32 0, i32 0), ; map
		%struct.TypeMapModuleEntry* getelementptr inbounds ([37 x %struct.TypeMapModuleEntry], [37 x %struct.TypeMapModuleEntry]* @module14_managed_to_java_duplicates, i32 0, i32 0), ; duplicate_map
...
@__java_type_names.1 = internal constant [32 x i8] c"xamarin/essentials/fileProvider\00", align 1
...
@__java_type_names.17 = internal constant [35 x i8] c"crc64c52abf5383b77486/MainActivity\00", align 1
...
@__java_type_names.40 = internal constant [47 x i8] c"xamarin/android/net/OldAndroidSSLSocketFactory\00", align 1
@__java_type_names.41 = internal constant [29 x i8] c"org/xmlpull/v1/XmlPullParser\00", align 1
@__java_type_names.42 = internal constant [38 x i8] c"org/xmlpull/v1/XmlPullParserException\00", align 1
@__java_type_names.43 = internal constant [32 x i8] c"javax/security/cert/Certificate\00", align 1
@__java_type_names.44 = internal constant [36 x i8] c"javax/security/cert/X509Certificate\00", align 1
@__java_type_names.45 = internal constant [28 x i8] c"javax/security/auth/Subject\00", align 1
...
@__java_type_names.58 = internal constant [39 x i8] c"javax/microedition/khronos/opengles/GL\00", align 1
@__java_type_names.59 = internal constant [41 x i8] c"javax/microedition/khronos/opengles/GL10\00", align 1
@__java_type_names.60 = internal constant [41 x i8] c"javax/microedition/khronos/egl/EGLConfig\00", align 1
@__java_type_names.61 = internal constant [37 x i8] c"android/window/OnBackInvokedCallback\00", align 1
@__java_type_names.62 = internal constant [39 x i8] c"android/window/OnBackInvokedDispatcher\00", align 1
@__java_type_names.63 = internal constant [27 x i8] c"android/widget/AbsListView\00", align 1
@__java_type_names.64 = internal constant [44 x i8] c"android/widget/AbsListView$OnScrollListener\00", align 1
@__java_type_names.65 = internal constant [30 x i8] c"android/widget/AbsoluteLayout\00", align 1
@__java_type_names.66 = internal constant [43 x i8] c"android/widget/AbsoluteLayout$LayoutParams\00", align 1
@__java_type_names.67 = internal constant [26 x i8] c"android/widget/AbsSeekBar\00", align 1
...
@__java_type_names.75 = internal constant [22 x i8] c"android/widget/Button\00", align 1
@__java_type_names.76 = internal constant [24 x i8] c"android/widget/CheckBox\00", align 1
@__java_type_names.77 = internal constant [30 x i8] c"android/widget/CompoundButton\00", align 1
@__java_type_names.78 = internal constant [54 x i8] c"android/widget/CompoundButton$OnCheckedChangeListener\00", align 1
@__java_type_names.79 = internal constant [26 x i8] c"android/widget/DatePicker\00", align 1
@__java_type_names.80 = internal constant [48 x i8] c"android/widget/DatePicker$OnDateChangedListener\00", align 1
@__java_type_names.81 = internal constant [26 x i8] c"android/widget/EdgeEffect\00", align 1
@__java_type_names.82 = internal constant [24 x i8] c"android/widget/EditText\00", align 1
@__java_type_names.83 = internal constant [22 x i8] c"android/widget/Filter\00", align 1
@__java_type_names.84 = internal constant [37 x i8] c"android/widget/Filter$FilterListener\00", align 1
@__java_type_names.85 = internal constant [36 x i8] c"android/widget/Filter$FilterResults\00", align 1
@__java_type_names.86 = internal constant [27 x i8] c"android/widget/FrameLayout\00", align 1
@__java_type_names.87 = internal constant [40 x i8] c"android/widget/FrameLayout$LayoutParams\00", align 1
@__java_type_names.88 = internal constant [36 x i8] c"android/widget/HorizontalScrollView\00", align 1
@__java_type_names.89 = internal constant [23 x i8] c"android/widget/Adapter\00", align 1
@__java_type_names.90 = internal constant [25 x i8] c"android/widget/Checkable\00", align 1
@__java_type_names.91 = internal constant [26 x i8] c"android/widget/Filterable\00", align 1
@__java_type_names.92 = internal constant [27 x i8] c"android/widget/ListAdapter\00", align 1
@__java_type_names.93 = internal constant [27 x i8] c"android/widget/ImageButton\00", align 1
@__java_type_names.94 = internal constant [25 x i8] c"android/widget/ImageView\00", align 1
@__java_type_names.95 = internal constant [35 x i8] c"android/widget/ImageView$ScaleType\00", align 1
@__java_type_names.96 = internal constant [30 x i8] c"android/widget/SectionIndexer\00", align 1
@__java_type_names.97 = internal constant [30 x i8] c"android/widget/SpinnerAdapter\00", align 1
@__java_type_names.98 = internal constant [28 x i8] c"android/widget/LinearLayout\00", align 1
@__java_type_names.99 = internal constant [41 x i8] c"android/widget/LinearLayout$LayoutParams\00", align 1
@__java_type_names.100 = internal constant [24 x i8] c"android/widget/ListView\00", align 1
@__java_type_names.101 = internal constant [31 x i8] c"android/widget/MediaController\00", align 1
@__java_type_names.102 = internal constant [50 x i8] c"android/widget/MediaController$MediaPlayerControl\00", align 1
@__java_type_names.103 = internal constant [28 x i8] c"android/widget/NumberPicker\00", align 1
@__java_type_names.104 = internal constant [27 x i8] c"android/widget/ProgressBar\00", align 1
@__java_type_names.105 = internal constant [27 x i8] c"android/widget/RadioButton\00", align 1
@__java_type_names.106 = internal constant [30 x i8] c"android/widget/RelativeLayout\00", align 1
@__java_type_names.107 = internal constant [43 x i8] c"android/widget/RelativeLayout$LayoutParams\00", align 1
@__java_type_names.108 = internal constant [26 x i8] c"android/widget/SearchView\00", align 1
@__java_type_names.109 = internal constant [46 x i8] c"android/widget/SearchView$OnQueryTextListener\00", align 1
@__java_type_names.110 = internal constant [23 x i8] c"android/widget/SeekBar\00", align 1
@__java_type_names.111 = internal constant [47 x i8] c"android/widget/SeekBar$OnSeekBarChangeListener\00", align 1
@__java_type_names.112 = internal constant [22 x i8] c"android/widget/Switch\00", align 1
@__java_type_names.113 = internal constant [24 x i8] c"android/widget/TextView\00", align 1
@__java_type_names.114 = internal constant [35 x i8] c"android/widget/TextView$BufferType\00", align 1
@__java_type_names.115 = internal constant [47 x i8] c"android/widget/TextView$OnEditorActionListener\00", align 1
@__java_type_names.116 = internal constant [26 x i8] c"android/widget/TimePicker\00", align 1
@__java_type_names.117 = internal constant [48 x i8] c"android/widget/TimePicker$OnTimeChangedListener\00", align 1
@__java_type_names.118 = internal constant [25 x i8] c"android/widget/VideoView\00", align 1
@__java_type_names.119 = internal constant [29 x i8] c"android/webkit/CookieManager\00", align 1
@__java_type_names.120 = internal constant [29 x i8] c"android/webkit/ValueCallback\00", align 1
@__java_type_names.121 = internal constant [34 x i8] c"android/webkit/WebResourceRequest\00", align 1
@__java_type_names.122 = internal constant [27 x i8] c"android/webkit/MimeTypeMap\00", align 1
@__java_type_names.123 = internal constant [31 x i8] c"android/webkit/WebChromeClient\00", align 1
@__java_type_names.124 = internal constant [49 x i8] c"android/webkit/WebChromeClient$FileChooserParams\00", align 1
@__java_type_names.125 = internal constant [32 x i8] c"android/webkit/WebResourceError\00", align 1
@__java_type_names.126 = internal constant [27 x i8] c"android/webkit/WebSettings\00", align 1
@__java_type_names.127 = internal constant [23 x i8] c"android/webkit/WebView\00", align 1
@__java_type_names.128 = internal constant [29 x i8] c"android/webkit/WebViewClient\00", align 1
@__java_type_names.129 = internal constant [24 x i8] c"android/view/ActionMode\00", align 1
@__java_type_names.130 = internal constant [33 x i8] c"android/view/ActionMode$Callback\00", align 1
@__java_type_names.131 = internal constant [28 x i8] c"android/view/ActionProvider\00", align 1
@__java_type_names.132 = internal constant [33 x i8] c"android/view/ContextThemeWrapper\00", align 1
@__java_type_names.133 = internal constant [21 x i8] c"android/view/Display\00", align 1
@__java_type_names.134 = internal constant [23 x i8] c"android/view/DragEvent\00", align 1
@__java_type_names.135 = internal constant [29 x i8] c"android/view/GestureDetector\00", align 1
@__java_type_names.136 = internal constant [49 x i8] c"android/view/GestureDetector$OnDoubleTapListener\00", align 1
@__java_type_names.137 = internal constant [47 x i8] c"android/view/GestureDetector$OnGestureListener\00", align 1
@__java_type_names.138 = internal constant [35 x i8] c"android/view/CollapsibleActionView\00", align 1
@__java_type_names.139 = internal constant [41 x i8] c"android/view/ContextMenu$ContextMenuInfo\00", align 1
@__java_type_names.140 = internal constant [25 x i8] c"android/view/ContextMenu\00", align 1
@__java_type_names.141 = internal constant [18 x i8] c"android/view/Menu\00", align 1
@__java_type_names.142 = internal constant [45 x i8] c"android/view/MenuItem$OnActionExpandListener\00", align 1
@__java_type_names.143 = internal constant [46 x i8] c"android/view/MenuItem$OnMenuItemClickListener\00", align 1
@__java_type_names.144 = internal constant [22 x i8] c"android/view/MenuItem\00", align 1
@__java_type_names.145 = internal constant [30 x i8] c"android/view/InflateException\00", align 1
@__java_type_names.146 = internal constant [24 x i8] c"android/view/InputEvent\00", align 1
@__java_type_names.147 = internal constant [21 x i8] c"android/view/SubMenu\00", align 1
@__java_type_names.148 = internal constant [36 x i8] c"android/view/SurfaceHolder$Callback\00", align 1
@__java_type_names.149 = internal constant [37 x i8] c"android/view/SurfaceHolder$Callback2\00", align 1
@__java_type_names.150 = internal constant [27 x i8] c"android/view/SurfaceHolder\00", align 1
...
@__java_type_names.156 = internal constant [22 x i8] c"android/view/KeyEvent\00", align 1
@__java_type_names.157 = internal constant [31 x i8] c"android/view/KeyEvent$Callback\00", align 1
@__java_type_names.158 = internal constant [28 x i8] c"android/view/LayoutInflater\00", align 1
@__java_type_names.159 = internal constant [36 x i8] c"android/view/LayoutInflater$Factory\00", align 1
@__java_type_names.160 = internal constant [37 x i8] c"android/view/LayoutInflater$Factory2\00", align 1
@__java_type_names.161 = internal constant [26 x i8] c"android/view/MenuInflater\00", align 1
@__java_type_names.162 = internal constant [25 x i8] c"android/view/MotionEvent\00", align 1
@__java_type_names.163 = internal constant [34 x i8] c"android/view/ScaleGestureDetector\00", align 1
@__java_type_names.164 = internal constant [57 x i8] c"android/view/ScaleGestureDetector$OnScaleGestureListener\00", align 1
@__java_type_names.165 = internal constant [63 x i8] c"android/view/ScaleGestureDetector$SimpleOnScaleGestureListener\00", align 1
@__java_type_names.166 = internal constant [25 x i8] c"android/view/SearchEvent\00", align 1
@__java_type_names.167 = internal constant [21 x i8] c"android/view/Surface\00", align 1
@__java_type_names.168 = internal constant [25 x i8] c"android/view/SurfaceView\00", align 1
@__java_type_names.169 = internal constant [18 x i8] c"android/view/View\00", align 1
@__java_type_names.170 = internal constant [40 x i8] c"android/view/View$AccessibilityDelegate\00", align 1
@__java_type_names.171 = internal constant [36 x i8] c"android/view/View$DragShadowBuilder\00", align 1
@__java_type_names.172 = internal constant [30 x i8] c"android/view/View$MeasureSpec\00", align 1
@__java_type_names.173 = internal constant [46 x i8] c"android/view/View$OnAttachStateChangeListener\00", align 1
@__java_type_names.174 = internal constant [62 x i8] c"mono/android/view/View_OnAttachStateChangeListenerImplementor\00", align 1
@__java_type_names.175 = internal constant [34 x i8] c"android/view/View$OnClickListener\00", align 1
@__java_type_names.176 = internal constant [50 x i8] c"mono/android/view/View_OnClickListenerImplementor\00", align 1
@__java_type_names.177 = internal constant [46 x i8] c"android/view/View$OnCreateContextMenuListener\00", align 1
@__java_type_names.178 = internal constant [33 x i8] c"android/view/View$OnDragListener\00", align 1
@__java_type_names.179 = internal constant [40 x i8] c"android/view/View$OnFocusChangeListener\00", align 1
@__java_type_names.180 = internal constant [32 x i8] c"android/view/View$OnKeyListener\00", align 1
@__java_type_names.181 = internal constant [48 x i8] c"mono/android/view/View_OnKeyListenerImplementor\00", align 1
@__java_type_names.182 = internal constant [41 x i8] c"android/view/View$OnLayoutChangeListener\00", align 1
@__java_type_names.183 = internal constant [57 x i8] c"mono/android/view/View_OnLayoutChangeListenerImplementor\00", align 1
@__java_type_names.184 = internal constant [34 x i8] c"android/view/View$OnTouchListener\00", align 1
@__java_type_names.185 = internal constant [50 x i8] c"mono/android/view/View_OnTouchListenerImplementor\00", align 1
@__java_type_names.186 = internal constant [31 x i8] c"android/view/ViewConfiguration\00", align 1
@__java_type_names.187 = internal constant [23 x i8] c"android/view/ViewGroup\00", align 1
@__java_type_names.188 = internal constant [36 x i8] c"android/view/ViewGroup$LayoutParams\00", align 1
@__java_type_names.189 = internal constant [42 x i8] c"android/view/ViewGroup$MarginLayoutParams\00", align 1
@__java_type_names.190 = internal constant [49 x i8] c"android/view/ViewGroup$OnHierarchyChangeListener\00", align 1
@__java_type_names.191 = internal constant [34 x i8] c"android/view/ViewPropertyAnimator\00", align 1
@__java_type_names.192 = internal constant [30 x i8] c"android/view/ViewTreeObserver\00", align 1
@__java_type_names.193 = internal constant [58 x i8] c"android/view/ViewTreeObserver$OnGlobalFocusChangeListener\00", align 1
@__java_type_names.194 = internal constant [53 x i8] c"android/view/ViewTreeObserver$OnGlobalLayoutListener\00", align 1
@__java_type_names.195 = internal constant [48 x i8] c"android/view/ViewTreeObserver$OnPreDrawListener\00", align 1
@__java_type_names.196 = internal constant [56 x i8] c"android/view/ViewTreeObserver$OnTouchModeChangeListener\00", align 1
@__java_type_names.197 = internal constant [20 x i8] c"android/view/Window\00", align 1
@__java_type_names.198 = internal constant [29 x i8] c"android/view/Window$Callback\00", align 1
@__java_type_names.199 = internal constant [26 x i8] c"android/view/WindowInsets\00", align 1
@__java_type_names.200 = internal constant [27 x i8] c"android/view/WindowMetrics\00", align 1
@__java_type_names.201 = internal constant [44 x i8] c"android/view/inputmethod/InputMethodManager\00", align 1
@__java_type_names.202 = internal constant [46 x i8] c"android/view/animation/AccelerateInterpolator\00", align 1
@__java_type_names.203 = internal constant [33 x i8] c"android/view/animation/Animation\00", align 1
@__java_type_names.204 = internal constant [51 x i8] c"android/view/animation/Animation$AnimationListener\00", align 1
@__java_type_names.205 = internal constant [36 x i8] c"android/view/animation/AnimationSet\00", align 1
@__java_type_names.206 = internal constant [38 x i8] c"android/view/animation/AnimationUtils\00", align 1
@__java_type_names.207 = internal constant [40 x i8] c"android/view/animation/BaseInterpolator\00", align 1
@__java_type_names.208 = internal constant [46 x i8] c"android/view/animation/DecelerateInterpolator\00", align 1
@__java_type_names.209 = internal constant [36 x i8] c"android/view/animation/Interpolator\00", align 1
@__java_type_names.210 = internal constant [42 x i8] c"android/view/animation/LinearInterpolator\00", align 1
@__java_type_names.211 = internal constant [46 x i8] c"android/view/accessibility/AccessibilityEvent\00", align 1
@__java_type_names.212 = internal constant [48 x i8] c"android/view/accessibility/AccessibilityManager\00", align 1
@__java_type_names.213 = internal constant [49 x i8] c"android/view/accessibility/AccessibilityNodeInfo\00", align 1
@__java_type_names.214 = internal constant [47 x i8] c"android/view/accessibility/AccessibilityRecord\00", align 1
@__java_type_names.215 = internal constant [52 x i8] c"android/view/accessibility/AccessibilityEventSource\00", align 1
@__java_type_names.216 = internal constant [28 x i8] c"android/util/DisplayMetrics\00", align 1
@__java_type_names.217 = internal constant [26 x i8] c"android/util/AttributeSet\00", align 1
@__java_type_names.218 = internal constant [22 x i8] c"android/util/LruCache\00", align 1
@__java_type_names.219 = internal constant [18 x i8] c"android/util/Pair\00", align 1
@__java_type_names.220 = internal constant [25 x i8] c"android/util/SparseArray\00", align 1
@__java_type_names.221 = internal constant [22 x i8] c"android/util/StateSet\00", align 1
@__java_type_names.222 = internal constant [24 x i8] c"android/util/TypedValue\00", align 1
@__java_type_names.223 = internal constant [18 x i8] c"android/text/Html\00", align 1
@__java_type_names.224 = internal constant [22 x i8] c"android/text/Editable\00", align 1
@__java_type_names.225 = internal constant [22 x i8] c"android/text/GetChars\00", align 1
@__java_type_names.226 = internal constant [38 x i8] c"android/text/InputFilter$LengthFilter\00", align 1
@__java_type_names.227 = internal constant [25 x i8] c"android/text/InputFilter\00", align 1
@__java_type_names.228 = internal constant [24 x i8] c"android/text/NoCopySpan\00", align 1
@__java_type_names.229 = internal constant [28 x i8] c"android/text/ParcelableSpan\00", align 1
@__java_type_names.230 = internal constant [23 x i8] c"android/text/Spannable\00", align 1
@__java_type_names.231 = internal constant [21 x i8] c"android/text/Spanned\00", align 1
@__java_type_names.232 = internal constant [36 x i8] c"android/text/TextDirectionHeuristic\00", align 1
@__java_type_names.233 = internal constant [25 x i8] c"android/text/TextWatcher\00", align 1
@__java_type_names.234 = internal constant [20 x i8] c"android/text/Layout\00", align 1
@__java_type_names.235 = internal constant [29 x i8] c"android/text/SpannableString\00", align 1
@__java_type_names.236 = internal constant [36 x i8] c"android/text/SpannableStringBuilder\00", align 1
@__java_type_names.237 = internal constant [37 x i8] c"android/text/SpannableStringInternal\00", align 1
@__java_type_names.238 = internal constant [23 x i8] c"android/text/TextPaint\00", align 1
@__java_type_names.239 = internal constant [23 x i8] c"android/text/TextUtils\00", align 1
@__java_type_names.240 = internal constant [34 x i8] c"android/text/TextUtils$TruncateAt\00", align 1
@__java_type_names.241 = internal constant [39 x i8] c"android/text/style/BackgroundColorSpan\00", align 1
@__java_type_names.242 = internal constant [34 x i8] c"android/text/style/CharacterStyle\00", align 1
@__java_type_names.243 = internal constant [33 x i8] c"android/text/style/ClickableSpan\00", align 1
@__java_type_names.244 = internal constant [39 x i8] c"android/text/style/ForegroundColorSpan\00", align 1
@__java_type_names.245 = internal constant [34 x i8] c"android/text/style/LineHeightSpan\00", align 1
@__java_type_names.246 = internal constant [34 x i8] c"android/text/style/ParagraphStyle\00", align 1
@__java_type_names.247 = internal constant [36 x i8] c"android/text/style/UpdateAppearance\00", align 1
@__java_type_names.248 = internal constant [32 x i8] c"android/text/style/UpdateLayout\00", align 1
@__java_type_names.249 = internal constant [36 x i8] c"android/text/style/WrapTogetherSpan\00", align 1
@__java_type_names.250 = internal constant [39 x i8] c"android/text/style/MetricAffectingSpan\00", align 1
@__java_type_names.251 = internal constant [36 x i8] c"android/text/method/BaseKeyListener\00", align 1
@__java_type_names.252 = internal constant [38 x i8] c"android/text/method/DigitsKeyListener\00", align 1
@__java_type_names.253 = internal constant [32 x i8] c"android/text/method/KeyListener\00", align 1
@__java_type_names.254 = internal constant [41 x i8] c"android/text/method/TransformationMethod\00", align 1
@__java_type_names.255 = internal constant [39 x i8] c"android/text/method/MetaKeyKeyListener\00", align 1
@__java_type_names.256 = internal constant [38 x i8] c"android/text/method/NumberKeyListener\00", align 1
@__java_type_names.257 = internal constant [31 x i8] c"android/text/format/DateFormat\00", align 1
@__java_type_names.258 = internal constant [26 x i8] c"android/provider/Settings\00", align 1
@__java_type_names.259 = internal constant [33 x i8] c"android/provider/Settings$Global\00", align 1
@__java_type_names.260 = internal constant [41 x i8] c"android/provider/Settings$NameValueTable\00", align 1
@__java_type_names.261 = internal constant [33 x i8] c"android/provider/Settings$System\00", align 1
@__java_type_names.262 = internal constant [37 x i8] c"android/preference/PreferenceManager\00", align 1
@__java_type_names.263 = internal constant [22 x i8] c"android/os/BaseBundle\00", align 1
@__java_type_names.264 = internal constant [17 x i8] c"android/os/Build\00", align 1
@__java_type_names.265 = internal constant [25 x i8] c"android/os/Build$VERSION\00", align 1
@__java_type_names.266 = internal constant [18 x i8] c"android/os/Bundle\00", align 1
@__java_type_names.267 = internal constant [30 x i8] c"android/os/CancellationSignal\00", align 1
@__java_type_names.268 = internal constant [23 x i8] c"android/os/Environment\00", align 1
@__java_type_names.269 = internal constant [19 x i8] c"android/os/Handler\00", align 1
@__java_type_names.270 = internal constant [34 x i8] c"android/os/IBinder$DeathRecipient\00", align 1
@__java_type_names.271 = internal constant [19 x i8] c"android/os/IBinder\00", align 1
@__java_type_names.272 = internal constant [22 x i8] c"android/os/IInterface\00", align 1
@__java_type_names.273 = internal constant [30 x i8] c"android/os/Parcelable$Creator\00", align 1
@__java_type_names.274 = internal constant [22 x i8] c"android/os/Parcelable\00", align 1
@__java_type_names.275 = internal constant [18 x i8] c"android/os/Looper\00", align 1
@__java_type_names.276 = internal constant [19 x i8] c"android/os/Message\00", align 1
@__java_type_names.277 = internal constant [18 x i8] c"android/os/Parcel\00", align 1
@__java_type_names.278 = internal constant [24 x i8] c"android/os/PowerManager\00", align 1
@__java_type_names.279 = internal constant [29 x i8] c"android/opengl/GLSurfaceView\00", align 1
@__java_type_names.280 = internal constant [38 x i8] c"android/opengl/GLSurfaceView$Renderer\00", align 1
@__java_type_names.281 = internal constant [16 x i8] c"android/net/Uri\00", align 1
@__java_type_names.282 = internal constant [37 x i8] c"android/media/MediaMetadataRetriever\00", align 1
@__java_type_names.283 = internal constant [24 x i8] c"android/graphics/Bitmap\00", align 1
@__java_type_names.284 = internal constant [31 x i8] c"android/graphics/Bitmap$Config\00", align 1
@__java_type_names.285 = internal constant [31 x i8] c"android/graphics/BitmapFactory\00", align 1
@__java_type_names.286 = internal constant [39 x i8] c"android/graphics/BitmapFactory$Options\00", align 1
@__java_type_names.287 = internal constant [27 x i8] c"android/graphics/BlendMode\00", align 1
@__java_type_names.288 = internal constant [38 x i8] c"android/graphics/BlendModeColorFilter\00", align 1
@__java_type_names.289 = internal constant [24 x i8] c"android/graphics/Canvas\00", align 1
@__java_type_names.290 = internal constant [29 x i8] c"android/graphics/ColorFilter\00", align 1
@__java_type_names.291 = internal constant [32 x i8] c"android/graphics/DashPathEffect\00", align 1
@__java_type_names.292 = internal constant [32 x i8] c"android/graphics/LinearGradient\00", align 1
@__java_type_names.293 = internal constant [24 x i8] c"android/graphics/Matrix\00", align 1
@__java_type_names.294 = internal constant [35 x i8] c"android/graphics/Matrix$ScaleToFit\00", align 1
@__java_type_names.295 = internal constant [23 x i8] c"android/graphics/Paint\00", align 1
@__java_type_names.296 = internal constant [29 x i8] c"android/graphics/Paint$Align\00", align 1
@__java_type_names.297 = internal constant [27 x i8] c"android/graphics/Paint$Cap\00", align 1
@__java_type_names.298 = internal constant [38 x i8] c"android/graphics/Paint$FontMetricsInt\00", align 1
@__java_type_names.299 = internal constant [28 x i8] c"android/graphics/Paint$Join\00", align 1
@__java_type_names.300 = internal constant [29 x i8] c"android/graphics/Paint$Style\00", align 1
@__java_type_names.301 = internal constant [22 x i8] c"android/graphics/Path\00", align 1
@__java_type_names.302 = internal constant [32 x i8] c"android/graphics/Path$Direction\00", align 1
@__java_type_names.303 = internal constant [31 x i8] c"android/graphics/Path$FillType\00", align 1
@__java_type_names.304 = internal constant [28 x i8] c"android/graphics/PathEffect\00", align 1
@__java_type_names.305 = internal constant [23 x i8] c"android/graphics/Point\00", align 1
@__java_type_names.306 = internal constant [24 x i8] c"android/graphics/PointF\00", align 1
@__java_type_names.307 = internal constant [28 x i8] c"android/graphics/PorterDuff\00", align 1
@__java_type_names.308 = internal constant [33 x i8] c"android/graphics/PorterDuff$Mode\00", align 1
@__java_type_names.309 = internal constant [39 x i8] c"android/graphics/PorterDuffColorFilter\00", align 1
...
@__java_type_names.319 = internal constant [49 x i8] c"android/graphics/drawable/AnimatedVectorDrawable\00", align 1
@__java_type_names.320 = internal constant [44 x i8] c"android/graphics/drawable/AnimationDrawable\00", align 1
@__java_type_names.321 = internal constant [41 x i8] c"android/graphics/drawable/BitmapDrawable\00", align 1
@__java_type_names.322 = internal constant [40 x i8] c"android/graphics/drawable/ColorDrawable\00", align 1
@__java_type_names.323 = internal constant [35 x i8] c"android/graphics/drawable/Drawable\00", align 1
@__java_type_names.324 = internal constant [44 x i8] c"android/graphics/drawable/Drawable$Callback\00", align 1
@__java_type_names.325 = internal constant [49 x i8] c"android/graphics/drawable/Drawable$ConstantState\00", align 1
@__java_type_names.326 = internal constant [44 x i8] c"android/graphics/drawable/DrawableContainer\00", align 1
@__java_type_names.327 = internal constant [43 x i8] c"android/graphics/drawable/GradientDrawable\00", align 1
@__java_type_names.328 = internal constant [55 x i8] c"android/graphics/drawable/GradientDrawable$Orientation\00", align 1
@__java_type_names.329 = internal constant [37 x i8] c"android/graphics/drawable/Animatable\00", align 1
@__java_type_names.330 = internal constant [56 x i8] c"android/graphics/drawable/Animatable2$AnimationCallback\00", align 1
@__java_type_names.331 = internal constant [38 x i8] c"android/graphics/drawable/Animatable2\00", align 1
@__java_type_names.332 = internal constant [40 x i8] c"android/graphics/drawable/LayerDrawable\00", align 1
...
@__java_type_names.342 = internal constant [33 x i8] c"android/database/CharArrayBuffer\00", align 1
@__java_type_names.343 = internal constant [33 x i8] c"android/database/ContentObserver\00", align 1
@__java_type_names.344 = internal constant [33 x i8] c"android/database/DataSetObserver\00", align 1
@__java_type_names.345 = internal constant [24 x i8] c"android/database/Cursor\00", align 1
@__java_type_names.346 = internal constant [27 x i8] c"android/animation/Animator\00", align 1
@__java_type_names.347 = internal constant [44 x i8] c"android/animation/Animator$AnimatorListener\00", align 1
@__java_type_names.348 = internal constant [49 x i8] c"android/animation/Animator$AnimatorPauseListener\00", align 1
...
@__java_type_names.351 = internal constant [32 x i8] c"android/animation/ValueAnimator\00", align 1
@__java_type_names.352 = internal constant [55 x i8] c"android/animation/ValueAnimator$AnimatorUpdateListener\00", align 1
@__java_type_names.353 = internal constant [71 x i8] c"mono/android/animation/ValueAnimator_AnimatorUpdateListenerImplementor\00", align 1
@__java_type_names.354 = internal constant [47 x i8] c"mono/android/animation/AnimatorEventDispatcher\00", align 1
@__java_type_names.355 = internal constant [22 x i8] c"android/app/ActionBar\00", align 1
@__java_type_names.356 = internal constant [26 x i8] c"android/app/ActionBar$Tab\00", align 1
@__java_type_names.357 = internal constant [34 x i8] c"android/app/ActionBar$TabListener\00", align 1
@__java_type_names.358 = internal constant [21 x i8] c"android/app/Activity\00", align 1
@__java_type_names.359 = internal constant [24 x i8] c"android/app/AlertDialog\00", align 1
@__java_type_names.360 = internal constant [32 x i8] c"android/app/AlertDialog$Builder\00", align 1
@__java_type_names.361 = internal constant [24 x i8] c"android/app/Application\00", align 1
@__java_type_names.362 = internal constant [51 x i8] c"android/app/Application$ActivityLifecycleCallbacks\00", align 1
@__java_type_names.363 = internal constant [29 x i8] c"android/app/DatePickerDialog\00", align 1
@__java_type_names.364 = internal constant [47 x i8] c"android/app/DatePickerDialog$OnDateSetListener\00", align 1
@__java_type_names.365 = internal constant [63 x i8] c"mono/android/app/DatePickerDialog_OnDateSetListenerImplementor\00", align 1
@__java_type_names.366 = internal constant [19 x i8] c"android/app/Dialog\00", align 1
@__java_type_names.367 = internal constant [32 x i8] c"android/app/FragmentTransaction\00", align 1
@__java_type_names.368 = internal constant [26 x i8] c"android/app/PendingIntent\00", align 1
@__java_type_names.369 = internal constant [29 x i8] c"android/app/TimePickerDialog\00", align 1
@__java_type_names.370 = internal constant [47 x i8] c"android/app/TimePickerDialog$OnTimeSetListener\00", align 1
@__java_type_names.371 = internal constant [26 x i8] c"android/app/UiModeManager\00", align 1
@__java_type_names.372 = internal constant [36 x i8] c"mono/android/app/TabEventDispatcher\00", align 1
@__java_type_names.373 = internal constant [34 x i8] c"android/content/BroadcastReceiver\00", align 1
@__java_type_names.374 = internal constant [25 x i8] c"android/content/ClipData\00", align 1
@__java_type_names.375 = internal constant [30 x i8] c"android/content/ClipData$Item\00", align 1
@__java_type_names.376 = internal constant [32 x i8] c"android/content/ClipDescription\00", align 1
@__java_type_names.377 = internal constant [30 x i8] c"android/content/ComponentName\00", align 1
@__java_type_names.378 = internal constant [32 x i8] c"android/content/ContentProvider\00", align 1
@__java_type_names.379 = internal constant [32 x i8] c"android/content/ContentResolver\00", align 1
@__java_type_names.380 = internal constant [30 x i8] c"android/content/ContentValues\00", align 1
@__java_type_names.381 = internal constant [24 x i8] c"android/content/Context\00", align 1
@__java_type_names.382 = internal constant [31 x i8] c"android/content/ContextWrapper\00", align 1
@__java_type_names.383 = internal constant [35 x i8] c"android/content/ComponentCallbacks\00", align 1
@__java_type_names.384 = internal constant [36 x i8] c"android/content/ComponentCallbacks2\00", align 1
...
@__java_type_names.393 = internal constant [32 x i8] c"android/content/DialogInterface\00", align 1
@__java_type_names.394 = internal constant [23 x i8] c"android/content/Intent\00", align 1
@__java_type_names.395 = internal constant [29 x i8] c"android/content/IntentFilter\00", align 1
@__java_type_names.396 = internal constant [29 x i8] c"android/content/IntentSender\00", align 1
@__java_type_names.397 = internal constant [41 x i8] c"android/content/SharedPreferences$Editor\00", align 1
@__java_type_names.398 = internal constant [67 x i8] c"android/content/SharedPreferences$OnSharedPreferenceChangeListener\00", align 1
@__java_type_names.399 = internal constant [34 x i8] c"android/content/SharedPreferences\00", align 1
@__java_type_names.400 = internal constant [33 x i8] c"android/content/res/AssetManager\00", align 1
@__java_type_names.401 = internal constant [35 x i8] c"android/content/res/ColorStateList\00", align 1
@__java_type_names.402 = internal constant [34 x i8] c"android/content/res/Configuration\00", align 1
@__java_type_names.403 = internal constant [38 x i8] c"android/content/res/XmlResourceParser\00", align 1
@__java_type_names.404 = internal constant [30 x i8] c"android/content/res/Resources\00", align 1
@__java_type_names.405 = internal constant [36 x i8] c"android/content/res/Resources$Theme\00", align 1
@__java_type_names.406 = internal constant [31 x i8] c"android/content/res/TypedArray\00", align 1
@__java_type_names.407 = internal constant [35 x i8] c"android/content/pm/ApplicationInfo\00", align 1
@__java_type_names.408 = internal constant [31 x i8] c"android/content/pm/PackageInfo\00", align 1
@__java_type_names.409 = internal constant [35 x i8] c"android/content/pm/PackageItemInfo\00", align 1
@__java_type_names.410 = internal constant [34 x i8] c"android/content/pm/PackageManager\00", align 1
@__java_type_names.411 = internal constant [29 x i8] c"android/content/pm/Signature\00", align 1
@__java_type_names.412 = internal constant [40 x i8] c"mono/android/runtime/InputStreamAdapter\00", align 1
@__java_type_names.413 = internal constant [31 x i8] c"mono/android/runtime/JavaArray\00", align 1
@__java_type_names.414 = internal constant [21 x i8] c"java/util/Collection\00", align 1
@__java_type_names.415 = internal constant [18 x i8] c"java/util/HashMap\00", align 1
@__java_type_names.416 = internal constant [20 x i8] c"java/util/ArrayList\00", align 1
@__java_type_names.417 = internal constant [32 x i8] c"mono/android/runtime/JavaObject\00", align 1
@__java_type_names.418 = internal constant [35 x i8] c"android/runtime/JavaProxyThrowable\00", align 1
@__java_type_names.419 = internal constant [18 x i8] c"java/util/HashSet\00", align 1
@__java_type_names.420 = internal constant [41 x i8] c"mono/android/runtime/OutputStreamAdapter\00", align 1
@__java_type_names.421 = internal constant [36 x i8] c"android/runtime/XmlReaderPullParser\00", align 1
@__java_type_names.422 = internal constant [21 x i8] c"java/util/Comparator\00", align 1
@__java_type_names.423 = internal constant [22 x i8] c"java/util/Enumeration\00", align 1
@__java_type_names.424 = internal constant [19 x i8] c"java/util/Iterator\00", align 1
@__java_type_names.425 = internal constant [22 x i8] c"java/util/Spliterator\00", align 1
@__java_type_names.426 = internal constant [17 x i8] c"java/util/Random\00", align 1
@__java_type_names.427 = internal constant [28 x i8] c"java/util/function/Consumer\00", align 1
@__java_type_names.428 = internal constant [28 x i8] c"java/util/function/Function\00", align 1
@__java_type_names.429 = internal constant [36 x i8] c"java/util/function/ToDoubleFunction\00", align 1
@__java_type_names.430 = internal constant [33 x i8] c"java/util/function/ToIntFunction\00", align 1
@__java_type_names.431 = internal constant [34 x i8] c"java/util/function/ToLongFunction\00", align 1
@__java_type_names.432 = internal constant [30 x i8] c"java/util/concurrent/Executor\00", align 1
@__java_type_names.433 = internal constant [28 x i8] c"java/util/concurrent/Future\00", align 1
@__java_type_names.434 = internal constant [30 x i8] c"java/util/concurrent/TimeUnit\00", align 1
@__java_type_names.435 = internal constant [24 x i8] c"java/text/DecimalFormat\00", align 1
@__java_type_names.436 = internal constant [31 x i8] c"java/text/DecimalFormatSymbols\00", align 1
@__java_type_names.437 = internal constant [23 x i8] c"java/text/NumberFormat\00", align 1
@__java_type_names.438 = internal constant [17 x i8] c"java/text/Format\00", align 1
@__java_type_names.439 = internal constant [24 x i8] c"java/security/Principal\00", align 1
@__java_type_names.440 = internal constant [23 x i8] c"java/security/KeyStore\00", align 1
@__java_type_names.441 = internal constant [42 x i8] c"java/security/KeyStore$LoadStoreParameter\00", align 1
@__java_type_names.442 = internal constant [43 x i8] c"java/security/KeyStore$ProtectionParameter\00", align 1
@__java_type_names.443 = internal constant [27 x i8] c"java/security/SecureRandom\00", align 1
@__java_type_names.444 = internal constant [31 x i8] c"java/security/cert/Certificate\00", align 1
@__java_type_names.445 = internal constant [38 x i8] c"java/security/cert/CertificateFactory\00", align 1
@__java_type_names.446 = internal constant [33 x i8] c"java/security/cert/X509Extension\00", align 1
@__java_type_names.447 = internal constant [35 x i8] c"java/security/cert/X509Certificate\00", align 1
@__java_type_names.448 = internal constant [16 x i8] c"java/nio/Buffer\00", align 1
@__java_type_names.449 = internal constant [20 x i8] c"java/nio/ByteBuffer\00", align 1
@__java_type_names.450 = internal constant [20 x i8] c"java/nio/CharBuffer\00", align 1
@__java_type_names.451 = internal constant [21 x i8] c"java/nio/FloatBuffer\00", align 1
@__java_type_names.452 = internal constant [19 x i8] c"java/nio/IntBuffer\00", align 1
@__java_type_names.453 = internal constant [30 x i8] c"java/nio/channels/FileChannel\00", align 1
@__java_type_names.454 = internal constant [30 x i8] c"java/nio/channels/ByteChannel\00", align 1
@__java_type_names.455 = internal constant [26 x i8] c"java/nio/channels/Channel\00", align 1
@__java_type_names.456 = internal constant [39 x i8] c"java/nio/channels/GatheringByteChannel\00", align 1
@__java_type_names.457 = internal constant [39 x i8] c"java/nio/channels/InterruptibleChannel\00", align 1
@__java_type_names.458 = internal constant [38 x i8] c"java/nio/channels/ReadableByteChannel\00", align 1
@__java_type_names.459 = internal constant [40 x i8] c"java/nio/channels/ScatteringByteChannel\00", align 1
@__java_type_names.460 = internal constant [38 x i8] c"java/nio/channels/SeekableByteChannel\00", align 1
@__java_type_names.461 = internal constant [38 x i8] c"java/nio/channels/WritableByteChannel\00", align 1
...
@__java_type_names.469 = internal constant [23 x i8] c"java/net/ProxySelector\00", align 1
@__java_type_names.470 = internal constant [23 x i8] c"java/net/SocketAddress\00", align 1
@__java_type_names.471 = internal constant [25 x i8] c"java/net/SocketException\00", align 1
@__java_type_names.472 = internal constant [32 x i8] c"java/net/SocketTimeoutException\00", align 1
@__java_type_names.473 = internal constant [33 x i8] c"java/net/UnknownServiceException\00", align 1
@__java_type_names.474 = internal constant [13 x i8] c"java/net/URI\00", align 1
...
@__java_type_names.477 = internal constant [30 x i8] c"java/lang/AbstractMethodError\00", align 1
@__java_type_names.478 = internal constant [18 x i8] c"java/lang/Boolean\00", align 1
@__java_type_names.479 = internal constant [15 x i8] c"java/lang/Byte\00", align 1
@__java_type_names.480 = internal constant [20 x i8] c"java/lang/Character\00", align 1
@__java_type_names.481 = internal constant [16 x i8] c"java/lang/Class\00", align 1
@__java_type_names.482 = internal constant [29 x i8] c"java/lang/ClassCastException\00", align 1
@__java_type_names.483 = internal constant [22 x i8] c"java/lang/ClassLoader\00", align 1
@__java_type_names.484 = internal constant [33 x i8] c"java/lang/ClassNotFoundException\00", align 1
@__java_type_names.485 = internal constant [17 x i8] c"java/lang/Double\00", align 1
...
@__java_type_names.488 = internal constant [20 x i8] c"java/lang/Exception\00", align 1
@__java_type_names.489 = internal constant [16 x i8] c"java/lang/Float\00", align 1
@__java_type_names.490 = internal constant [21 x i8] c"java/lang/Appendable\00", align 1
@__java_type_names.491 = internal constant [24 x i8] c"java/lang/AutoCloseable\00", align 1
@__java_type_names.492 = internal constant [23 x i8] c"java/lang/CharSequence\00", align 1
@__java_type_names.493 = internal constant [20 x i8] c"java/lang/Cloneable\00", align 1
@__java_type_names.494 = internal constant [21 x i8] c"java/lang/Comparable\00", align 1
@__java_type_names.495 = internal constant [19 x i8] c"java/lang/Iterable\00", align 1
@__java_type_names.496 = internal constant [35 x i8] c"java/lang/IllegalArgumentException\00", align 1
@__java_type_names.497 = internal constant [32 x i8] c"java/lang/IllegalStateException\00", align 1
@__java_type_names.498 = internal constant [39 x i8] c"java/lang/IncompatibleClassChangeError\00", align 1
@__java_type_names.499 = internal constant [36 x i8] c"java/lang/IndexOutOfBoundsException\00", align 1
@__java_type_names.500 = internal constant [18 x i8] c"java/lang/Integer\00", align 1
@__java_type_names.501 = internal constant [19 x i8] c"java/lang/Readable\00", align 1
@__java_type_names.502 = internal constant [19 x i8] c"java/lang/Runnable\00", align 1
@__java_type_names.503 = internal constant [23 x i8] c"java/lang/LinkageError\00", align 1
@__java_type_names.504 = internal constant [15 x i8] c"java/lang/Long\00", align 1
@__java_type_names.505 = internal constant [31 x i8] c"java/lang/NoClassDefFoundError\00", align 1
@__java_type_names.506 = internal constant [31 x i8] c"java/lang/NullPointerException\00", align 1
@__java_type_names.507 = internal constant [17 x i8] c"java/lang/Number\00", align 1
@__java_type_names.508 = internal constant [17 x i8] c"java/lang/Object\00", align 1
@__java_type_names.509 = internal constant [39 x i8] c"java/lang/ReflectiveOperationException\00", align 1
@__java_type_names.510 = internal constant [18 x i8] c"java/lang/Runtime\00", align 1
@__java_type_names.511 = internal constant [27 x i8] c"java/lang/RuntimeException\00", align 1
@__java_type_names.512 = internal constant [28 x i8] c"java/lang/SecurityException\00", align 1
@__java_type_names.513 = internal constant [16 x i8] c"java/lang/Short\00", align 1
@__java_type_names.514 = internal constant [17 x i8] c"java/lang/String\00", align 1
@__java_type_names.515 = internal constant [17 x i8] c"java/lang/Thread\00", align 1
@__java_type_names.516 = internal constant [35 x i8] c"mono/java/lang/RunnableImplementor\00", align 1
@__java_type_names.517 = internal constant [20 x i8] c"java/lang/Throwable\00", align 1
@__java_type_names.518 = internal constant [40 x i8] c"java/lang/UnsupportedOperationException\00", align 1
@__java_type_names.519 = internal constant [24 x i8] c"mono/java/lang/Runnable\00", align 1
@__java_type_names.520 = internal constant [35 x i8] c"java/lang/reflect/AccessibleObject\00", align 1
@__java_type_names.521 = internal constant [29 x i8] c"java/lang/reflect/Executable\00", align 1
@__java_type_names.522 = internal constant [35 x i8] c"java/lang/reflect/AnnotatedElement\00", align 1
@__java_type_names.523 = internal constant [37 x i8] c"java/lang/reflect/GenericDeclaration\00", align 1
@__java_type_names.524 = internal constant [25 x i8] c"java/lang/reflect/Member\00", align 1
@__java_type_names.525 = internal constant [23 x i8] c"java/lang/reflect/Type\00", align 1
@__java_type_names.526 = internal constant [31 x i8] c"java/lang/reflect/TypeVariable\00", align 1
@__java_type_names.527 = internal constant [25 x i8] c"java/lang/reflect/Method\00", align 1
@__java_type_names.528 = internal constant [32 x i8] c"java/lang/annotation/Annotation\00", align 1
@__java_type_names.529 = internal constant [13 x i8] c"java/io/File\00", align 1
@__java_type_names.530 = internal constant [23 x i8] c"java/io/FileDescriptor\00", align 1
@__java_type_names.531 = internal constant [24 x i8] c"java/io/FileInputStream\00", align 1
@__java_type_names.532 = internal constant [18 x i8] c"java/io/Closeable\00", align 1
@__java_type_names.533 = internal constant [18 x i8] c"java/io/Flushable\00", align 1
@__java_type_names.534 = internal constant [20 x i8] c"java/io/InputStream\00", align 1
@__java_type_names.535 = internal constant [31 x i8] c"java/io/InterruptedIOException\00", align 1
@__java_type_names.536 = internal constant [20 x i8] c"java/io/IOException\00", align 1
@__java_type_names.537 = internal constant [21 x i8] c"java/io/Serializable\00", align 1
@__java_type_names.538 = internal constant [21 x i8] c"java/io/OutputStream\00", align 1
@__java_type_names.539 = internal constant [20 x i8] c"java/io/PrintWriter\00", align 1
@__java_type_names.540 = internal constant [15 x i8] c"java/io/Reader\00", align 1
@__java_type_names.541 = internal constant [21 x i8] c"java/io/StringWriter\00", align 1
@__java_type_names.542 = internal constant [15 x i8] c"java/io/Writer\00", align 1
@__java_type_names.543 = internal constant [25 x i8] c"mono/android/TypeManager\00", align 1
...
@__java_type_names.558 = internal constant [53 x i8] c"androidx/appcompat/graphics/drawable/DrawableWrapper\00", align 1
@__java_type_names.559 = internal constant [50 x i8] c"androidx/appcompat/content/res/AppCompatResources\00", align 1
@__java_type_names.560 = internal constant [28 x i8] c"androidx/lifecycle/Observer\00", align 1
@__java_type_names.561 = internal constant [28 x i8] c"androidx/lifecycle/LiveData\00", align 1
@__java_type_names.562 = internal constant [42 x i8] c"androidx/legacy/app/ActionBarDrawerToggle\00", align 1
@__java_type_names.563 = internal constant [44 x i8] c"androidx/savedstate/SavedStateRegistryOwner\00", align 1
@__java_type_names.564 = internal constant [39 x i8] c"androidx/savedstate/SavedStateRegistry\00", align 1
@__java_type_names.565 = internal constant [58 x i8] c"androidx/savedstate/SavedStateRegistry$SavedStateProvider\00", align 1
@__java_type_names.566 = internal constant [29 x i8] c"androidx/core/util/Predicate\00", align 1
@__java_type_names.567 = internal constant [24 x i8] c"androidx/core/util/Pair\00", align 1
@__java_type_names.568 = internal constant [40 x i8] c"androidx/core/internal/view/SupportMenu\00", align 1
@__java_type_names.569 = internal constant [44 x i8] c"androidx/core/internal/view/SupportMenuItem\00", align 1
@__java_type_names.570 = internal constant [30 x i8] c"androidx/core/graphics/Insets\00", align 1
@__java_type_names.571 = internal constant [47 x i8] c"androidx/core/graphics/drawable/DrawableCompat\00", align 1
@__java_type_names.572 = internal constant [36 x i8] c"androidx/core/content/ContextCompat\00", align 1
@__java_type_names.573 = internal constant [35 x i8] c"androidx/core/content/FileProvider\00", align 1
@__java_type_names.574 = internal constant [36 x i8] c"androidx/core/content/LocusIdCompat\00", align 1
@__java_type_names.575 = internal constant [40 x i8] c"androidx/core/content/PermissionChecker\00", align 1
@__java_type_names.576 = internal constant [43 x i8] c"androidx/core/content/pm/PackageInfoCompat\00", align 1
@__java_type_names.577 = internal constant [33 x i8] c"androidx/core/app/ActivityCompat\00", align 1
@__java_type_names.578 = internal constant [68 x i8] c"androidx/core/app/ActivityCompat$OnRequestPermissionsResultCallback\00", align 1
@__java_type_names.579 = internal constant [58 x i8] c"androidx/core/app/ActivityCompat$PermissionCompatDelegate\00", align 1
@__java_type_names.580 = internal constant [72 x i8] c"androidx/core/app/ActivityCompat$RequestPermissionsRequestCodeValidator\00", align 1
@__java_type_names.581 = internal constant [40 x i8] c"androidx/core/app/ActivityOptionsCompat\00", align 1
@__java_type_names.582 = internal constant [36 x i8] c"androidx/core/app/ComponentActivity\00", align 1
@__java_type_names.583 = internal constant [46 x i8] c"androidx/core/app/ComponentActivity$ExtraData\00", align 1
@__java_type_names.584 = internal constant [40 x i8] c"androidx/core/app/SharedElementCallback\00", align 1
@__java_type_names.585 = internal constant [70 x i8] c"androidx/core/app/SharedElementCallback$OnSharedElementsReadyListener\00", align 1
@__java_type_names.586 = internal constant [35 x i8] c"androidx/core/app/TaskStackBuilder\00", align 1
@__java_type_names.587 = internal constant [53 x i8] c"androidx/core/app/TaskStackBuilder$SupportParentable\00", align 1
@__java_type_names.588 = internal constant [38 x i8] c"androidx/core/widget/NestedScrollView\00", align 1
@__java_type_names.589 = internal constant [61 x i8] c"androidx/core/widget/NestedScrollView$OnScrollChangeListener\00", align 1
@__java_type_names.590 = internal constant [77 x i8] c"mono/androidx/core/widget/NestedScrollView_OnScrollChangeListenerImplementor\00", align 1
@__java_type_names.591 = internal constant [42 x i8] c"androidx/core/widget/CompoundButtonCompat\00", align 1
@__java_type_names.592 = internal constant [42 x i8] c"androidx/core/widget/AutoSizeableTextView\00", align 1
@__java_type_names.593 = internal constant [44 x i8] c"androidx/core/widget/TintableCompoundButton\00", align 1
@__java_type_names.594 = internal constant [51 x i8] c"androidx/core/widget/TintableCompoundDrawablesView\00", align 1
@__java_type_names.595 = internal constant [45 x i8] c"androidx/core/widget/TintableImageSourceView\00", align 1
@__java_type_names.596 = internal constant [36 x i8] c"androidx/core/widget/TextViewCompat\00", align 1
@__java_type_names.597 = internal constant [42 x i8] c"androidx/core/view/NestedScrollingParent2\00", align 1
@__java_type_names.598 = internal constant [47 x i8] c"androidx/core/view/AccessibilityDelegateCompat\00", align 1
@__java_type_names.599 = internal constant [34 x i8] c"androidx/core/view/ActionProvider\00", align 1
@__java_type_names.600 = internal constant [58 x i8] c"androidx/core/view/ActionProvider$SubUiVisibilityListener\00", align 1
@__java_type_names.601 = internal constant [74 x i8] c"mono/androidx/core/view/ActionProvider_SubUiVisibilityListenerImplementor\00", align 1
@__java_type_names.602 = internal constant [53 x i8] c"androidx/core/view/ActionProvider$VisibilityListener\00", align 1
@__java_type_names.603 = internal constant [69 x i8] c"mono/androidx/core/view/ActionProvider_VisibilityListenerImplementor\00", align 1
@__java_type_names.604 = internal constant [37 x i8] c"androidx/core/view/ContentInfoCompat\00", align 1
@__java_type_names.605 = internal constant [39 x i8] c"androidx/core/view/DisplayCutoutCompat\00", align 1
@__java_type_names.606 = internal constant [48 x i8] c"androidx/core/view/DragAndDropPermissionsCompat\00", align 1
@__java_type_names.607 = internal constant [40 x i8] c"androidx/core/view/NestedScrollingChild\00", align 1
@__java_type_names.608 = internal constant [41 x i8] c"androidx/core/view/NestedScrollingChild2\00", align 1
@__java_type_names.609 = internal constant [41 x i8] c"androidx/core/view/NestedScrollingChild3\00", align 1
@__java_type_names.610 = internal constant [41 x i8] c"androidx/core/view/NestedScrollingParent\00", align 1
@__java_type_names.611 = internal constant [42 x i8] c"androidx/core/view/NestedScrollingParent3\00", align 1
@__java_type_names.612 = internal constant [47 x i8] c"androidx/core/view/OnApplyWindowInsetsListener\00", align 1
@__java_type_names.613 = internal constant [44 x i8] c"androidx/core/view/OnReceiveContentListener\00", align 1
@__java_type_names.614 = internal constant [33 x i8] c"androidx/core/view/ScrollingView\00", align 1
@__java_type_names.615 = internal constant [42 x i8] c"androidx/core/view/TintableBackgroundView\00", align 1
@__java_type_names.616 = internal constant [48 x i8] c"androidx/core/view/ViewPropertyAnimatorListener\00", align 1
@__java_type_names.617 = internal constant [54 x i8] c"androidx/core/view/ViewPropertyAnimatorUpdateListener\00", align 1
@__java_type_names.618 = internal constant [62 x i8] c"androidx/core/view/WindowInsetsAnimationControlListenerCompat\00", align 1
@__java_type_names.619 = internal constant [38 x i8] c"androidx/core/view/KeyEventDispatcher\00", align 1
@__java_type_names.620 = internal constant [48 x i8] c"androidx/core/view/KeyEventDispatcher$Component\00", align 1
@__java_type_names.621 = internal constant [34 x i8] c"androidx/core/view/MenuItemCompat\00", align 1
@__java_type_names.622 = internal constant [57 x i8] c"androidx/core/view/MenuItemCompat$OnActionExpandListener\00", align 1
@__java_type_names.623 = internal constant [37 x i8] c"androidx/core/view/PointerIconCompat\00", align 1
@__java_type_names.624 = internal constant [46 x i8] c"androidx/core/view/ScaleGestureDetectorCompat\00", align 1
@__java_type_names.625 = internal constant [30 x i8] c"androidx/core/view/ViewCompat\00", align 1
@__java_type_names.626 = internal constant [64 x i8] c"androidx/core/view/ViewCompat$OnUnhandledKeyEventListenerCompat\00", align 1
@__java_type_names.627 = internal constant [46 x i8] c"androidx/core/view/ViewPropertyAnimatorCompat\00", align 1
@__java_type_names.628 = internal constant [47 x i8] c"androidx/core/view/WindowInsetsAnimationCompat\00", align 1
@__java_type_names.629 = internal constant [60 x i8] c"androidx/core/view/WindowInsetsAnimationCompat$BoundsCompat\00", align 1
@__java_type_names.630 = internal constant [56 x i8] c"androidx/core/view/WindowInsetsAnimationCompat$Callback\00", align 1
@__java_type_names.631 = internal constant [57 x i8] c"androidx/core/view/WindowInsetsAnimationControllerCompat\00", align 1
@__java_type_names.632 = internal constant [38 x i8] c"androidx/core/view/WindowInsetsCompat\00", align 1
@__java_type_names.633 = internal constant [48 x i8] c"androidx/core/view/WindowInsetsControllerCompat\00", align 1
@__java_type_names.634 = internal constant [84 x i8] c"androidx/core/view/WindowInsetsControllerCompat$OnControllableInsetsChangedListener\00", align 1
@__java_type_names.635 = internal constant [100 x i8] c"mono/androidx/core/view/WindowInsetsControllerCompat_OnControllableInsetsChangedListenerImplementor\00", align 1
@__java_type_names.636 = internal constant [61 x i8] c"androidx/core/view/accessibility/AccessibilityNodeInfoCompat\00", align 1
@__java_type_names.637 = internal constant [87 x i8] c"androidx/core/view/accessibility/AccessibilityNodeInfoCompat$AccessibilityActionCompat\00", align 1
@__java_type_names.638 = internal constant [82 x i8] c"androidx/core/view/accessibility/AccessibilityNodeInfoCompat$CollectionInfoCompat\00", align 1
@__java_type_names.639 = internal constant [86 x i8] c"androidx/core/view/accessibility/AccessibilityNodeInfoCompat$CollectionItemInfoCompat\00", align 1
@__java_type_names.640 = internal constant [77 x i8] c"androidx/core/view/accessibility/AccessibilityNodeInfoCompat$RangeInfoCompat\00", align 1
@__java_type_names.641 = internal constant [85 x i8] c"androidx/core/view/accessibility/AccessibilityNodeInfoCompat$TouchDelegateInfoCompat\00", align 1
@__java_type_names.642 = internal constant [65 x i8] c"androidx/core/view/accessibility/AccessibilityNodeProviderCompat\00", align 1
@__java_type_names.643 = internal constant [63 x i8] c"androidx/core/view/accessibility/AccessibilityWindowInfoCompat\00", align 1
@__java_type_names.644 = internal constant [75 x i8] c"androidx/core/view/accessibility/AccessibilityViewCommand$CommandArguments\00", align 1
@__java_type_names.645 = internal constant [58 x i8] c"androidx/core/view/accessibility/AccessibilityViewCommand\00", align 1
@__java_type_names.646 = internal constant [41 x i8] c"androidx/core/text/PrecomputedTextCompat\00", align 1
@__java_type_names.647 = internal constant [48 x i8] c"androidx/core/text/PrecomputedTextCompat$Params\00", align 1
...
@java_type_names = local_unnamed_addr constant [1003 x i8*] [
	...
	i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__java_type_names.78, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__java_type_names.83, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([40 x i8], [40 x i8]* @__java_type_names.87, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__java_type_names.194, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__java_type_names.234, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__java_type_names.264, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__java_type_names.271, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([49 x i8], [49 x i8]* @__java_type_names.325, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([56 x i8], [56 x i8]* @__java_type_names.330, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([71 x i8], [71 x i8]* @__java_type_names.353, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([63 x i8], [63 x i8]* @__java_type_names.365, i32 0, i32 0),
	i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__java_type_names.366, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__java_type_names.474, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__java_type_names.479, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__java_type_names.489, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__java_type_names.529, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([58 x i8], [58 x i8]* @__java_type_names.565, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__java_type_names.569, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([72 x i8], [72 x i8]* @__java_type_names.580, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([70 x i8], [70 x i8]* @__java_type_names.585, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([61 x i8], [61 x i8]* @__java_type_names.589, i32 0, i32 0),
	i8* getelementptr inbounds ([77 x i8], [77 x i8]* @__java_type_names.590, i32 0, i32 0),
	i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__java_type_names.591, i32 0, i32 0),
	i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__java_type_names.592, i32 0, i32 0),
	i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__java_type_names.593, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__java_type_names.602, i32 0, i32 0),
	i8* getelementptr inbounds ([69 x i8], [69 x i8]* @__java_type_names.603, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__java_type_names.618, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([64 x i8], [64 x i8]* @__java_type_names.626, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([84 x i8], [84 x i8]* @__java_type_names.634, i32 0, i32 0),
	i8* getelementptr inbounds ([100 x i8], [100 x i8]* @__java_type_names.635, i32 0, i32 0),
	i8* getelementptr inbounds ([61 x i8], [61 x i8]* @__java_type_names.636, i32 0, i32 0),
	i8* getelementptr inbounds ([87 x i8], [87 x i8]* @__java_type_names.637, i32 0, i32 0),
	i8* getelementptr inbounds ([82 x i8], [82 x i8]* @__java_type_names.638, i32 0, i32 0),
	i8* getelementptr inbounds ([86 x i8], [86 x i8]* @__java_type_names.639, i32 0, i32 0),
	i8* getelementptr inbounds ([77 x i8], [77 x i8]* @__java_type_names.640, i32 0, i32 0),
	i8* getelementptr inbounds ([85 x i8], [85 x i8]* @__java_type_names.641, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([75 x i8], [75 x i8]* @__java_type_names.644, i32 0, i32 0),
